 ...
 * @desc [ two-factor two factor authentication factory]
 */

namespace Database\Factories\Jmrashed\TwoFactorAuth;
...
/**
 * @method \Jmrashed\TwoFactorAuth\Models\TwoFactorAuthentication make($attributes = [], ?Model $parent = null)
 * @method \Jmrashed\TwoFactorAuth\Models\TwoFactorAuthentication create($attributes = [], ?Model $parent = null)
 */
